 ...
 */
public final class SparseVectorOutputter extends AbstractJob {
  
  private static final Logger log = LoggerFactory.getLogger(SparseVectorOutputter.class);
  
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new SparseVectorOutputter(), args);
  }
