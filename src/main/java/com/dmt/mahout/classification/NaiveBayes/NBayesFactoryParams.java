...
public class NBayesFactoryParams {
	 ...
	 */
	public NBayesFactoryParams(String trainingseqfile, String shortLabel)
	{
		workingDIR = "for-testing";
		NBayesFactoryParams.trainingseqfile = trainingseqfile;
		NBayesFactoryParams.shortLabel = shortLabel;
		NBayesFactoryParams.workingFULL = workingDIR + "/" + shortLabel;
	...
	{
		NBayesFactoryParams.workingDIR = workingDIR;
		NBayesFactoryParams.trainingseqfile = trainingseqfile;
		NBayesFactoryParams.shortLabel = shortLabel;
		NBayesFactoryParams.workingFULL = workingDIR + "/" + shortLabel;
		NBayesFactoryParams.modelDIR = workingDIR + "/model" + "-" + shortLabel;

		NBayesFactoryParams.randomselectionPct = randomSelectionpct;
		NBayesFactoryParams.trainComplementary = trainComplementary;
		NBayesFactoryParams.logNormalize = logNormalize;
		NBayesFactoryParams.nGramsize = nGramsize;
		NBayesFactoryParams.weight = weight;
	}
